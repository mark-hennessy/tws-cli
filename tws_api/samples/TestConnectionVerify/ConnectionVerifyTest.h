...
private:
	...
	IBString base64_decode(IBString& encoded_string);
	IBString base64_encode(IBString& decoded_string);
	IBString calculateSHA1Signature(const IBString &str);
	IBString signDataWithPrivateKey(const IBString& apiData);
