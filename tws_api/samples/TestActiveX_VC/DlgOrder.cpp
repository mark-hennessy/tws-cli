...
void CDlgOrder::init(CString dlgTitle, DialogType dlgType, CString managedAccounts, ITagValueList* comOptions) 
{
    m_dlgTitle = dlgTitle;
    m_dlgType = dlgType;
    m_managedAccounts = managedAccounts;
	m_comOptions = comOptions;
}
...
void CDlgOrder::OnBtnUnderComp()
{
	...
	if (nRet == IDOK) {
		Props::Put(m_comContract, m_comUnderComp, &IContract::putref_underComp);
	}
	else if (nRet == IDRESET) {
		Props::Put(m_comContract, (IUnderComp*)NULL, &IContract::putref_underComp);
	}
}
...
void CDlgOrder::OnBtnAlgoParams() 
{
	...
	if ( dlgAlgoParams.DoModal() == IDOK ) {
		...
		Props::Put(m_comOrder, algoParams, &IOrder::putref_algoParams);
	}
}
...
void CDlgOrder::OnBtnSmartComboRoutingParams() 
{
	...
	CDlgSmartComboRoutingParams dlgSmartComboRoutingParams(smartComboRoutingParams, m_pTws, "Smart Combo Routing Parameters");
	if ( dlgSmartComboRoutingParams.DoModal() == IDOK ) {
		smartComboRoutingParams = dlgSmartComboRoutingParams.getSmartComboRoutingParams();
		Props::Put(m_comOrder, smartComboRoutingParams, &IOrder::putref_smartComboRoutingParams);
	}
}
...
void CDlgOrder::OnBtnOptions()
{
	...
	CDlgSmartComboRoutingParams dlgSmartComboRoutingParams(m_comOptions, m_pTws, dlgTitle);
	if ( dlgSmartComboRoutingParams.DoModal() == IDOK ) {
		m_comOptions = dlgSmartComboRoutingParams.getSmartComboRoutingParams();
	}
