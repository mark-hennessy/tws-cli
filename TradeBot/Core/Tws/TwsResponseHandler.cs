...
namespace TradeBot.Core.Tws
{
    public class TwsResponseHandler : EWrapper
    {
        ...
        {
            Messenger.ShowMessage(Messages.TWS_INFO_CONNECTIONCLOSED, MessageType.ERROR);
        }
        ...
        {
            Messenger.ShowMessage(Messages.TWS_INFO_CURRENTTIME, MessageType.INFO, time);
        }
        ...
        {
            Messenger.ShowMessage(Messages.TWS_ERROR, MessageType.ERROR, errorMessage);
        }

        public void error(Exception exception)
        {
            Messenger.ShowMessage(Messages.TWS_ERROR, MessageType.ERROR, exception.Message);
        }
        ...
        public void error(int id, int errorCode, string errorMessage)
        {
            ...
            {
                Messenger.ShowMessage(Messages.TWS_INFO, MessageType.INFO, errorMessage);
            }
            else
            {
                Messenger.ShowMessage(Messages.TWS_ERROR, MessageType.ERROR, errorMessage);
        ...
        {
            Messenger.ShowMessage(Messages.TWS_INFO_ACCOUNT_ID, MessageType.INFO, accounts);
            if (accounts.Contains(Preferences.ACCOUNT_LIVE))
            {
                Messenger.ShowMessage(Messages.TWS_INFO_ACCOUNT_TYPE_LIVE, MessageType.ERROR);
            }
            if (accounts.Contains(Preferences.ACCOUNT_PAPER))
            {
                Messenger.ShowMessage(Messages.TWS_INFO_ACCOUNT_TYPE_PAPER, MessageType.SUCCESS);
            }
        }
        ...
        {
            Messenger.ShowMessage(Messages.TWS_INFO_NEXTVALIDID, MessageType.INFO, orderId);
        }
        ...
        {
            Messenger.ShowMessage(Messages.TWS_INFO_TICKPRICE, MessageType.INFO, tickerId, field, price, canAutoExecute);
        }

        public void tickSize(int tickerId, int field, int size)
        {
            Messenger.ShowMessage(Messages.TWS_INFO_TICKSIZE, MessageType.INFO, tickerId, field, size);
        }

        public void tickSnapshotEnd(int tickerId)
        {
            Messenger.ShowMessage(Messages.TWS_INFO_TICKSNAPSHOTEND, MessageType.INFO, tickerId);
        }
